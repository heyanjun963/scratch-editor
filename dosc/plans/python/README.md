# plans/python/ — Python 编码模式

从“积木生成 Python 文本”演进到“生成 `.py`、本机运行、Terminal 交互”的相关方案，按阶段排列。

| 文档 | 阶段/主题 | 状态提示 |
| - | - | - |
| [01 Python 编码模式开发方案](./01-python-coding-mode-implementation-plan.md) | MVP：右侧代码区+控制台 | 拖积木生成 Python 示例文本 |
