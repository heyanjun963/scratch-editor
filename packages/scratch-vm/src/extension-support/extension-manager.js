...
const builtinExtensions = {
    ...
    companyHttp: () => require('../extensions/scratch3_company_http'),
    pythonControl: () => require('../extensions/scratch3_python_control'),
    pythonOperators: () => require('../extensions/scratch3_python_operators'),
