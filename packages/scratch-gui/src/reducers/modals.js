...
const MODAL_LIBRARY_MANAGER = 'libraryManager';
...
const MODAL_HELLO_SCRATCH = 'helloScratchModal';
...
const openLibraryManager = function () {
    return openModal(MODAL_LIBRARY_MANAGER);
};
...
const openHelloScratchModal = function () {
    return openModal(MODAL_HELLO_SCRATCH);
};
...
const closeLibraryManager = function () {
    return closeModal(MODAL_LIBRARY_MANAGER);
};
...
const closeHelloScratchModal = function () {
    return closeModal(MODAL_HELLO_SCRATCH);
};
export {
    reducer as default,
